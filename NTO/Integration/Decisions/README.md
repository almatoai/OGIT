...
- Vertices in `Decisions/Audit/` reference subjects only by stable pseudonymous identifiers that survive RtE; raw PII fields (e.g. `source_record_id`, `unrecognised_payload`) MUST be pseudonymised at ingest.
